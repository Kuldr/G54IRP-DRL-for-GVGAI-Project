...
\begin{itemize}
    ...
    \begin{itemize}
        \item Game Playing
        \item More info about the Open AI five
        \item Read the full open AI five blog
    \end{itemize}
\end{itemize}
